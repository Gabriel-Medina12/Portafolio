...
function mostrarAutos(autos){
    ...
    //construir el HTML para colocar el listado de los autos encontrados
    autos.forEach(auto => {
        const autoHTML = document.createElement('p');
        autoHTML.innerHTML = `
        <p>${auto.marca} - ${auto.modelo} - ${auto.year} - Puertas: ${auto.puertas} - Transmision:${auto.transmision} - Precio: ${auto.precio} - Color: ${auto.color}
        `;
